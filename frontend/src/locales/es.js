...
export default {
  ...
  "This browser doesn't support passkeys — you can still use MiGYM locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar MiGYM localmente en este dispositivo.',
  ...
  'A small file a friend imports into their own MiGYM — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio MiGYM: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'this isn’t a MiGYM plan file': 'esto no es un archivo de plan de MiGYM',
  ...
  'joined {0}': 'se unió {0}',
  'Last sync': 'Última sinc.',
  'Disable {0}?': '¿Desactivar a {0}?',
  'They are signed out everywhere and can no longer sync or log in until re-enabled.': 'Se cierra su sesión en todos lados y no podrán sincronizar ni entrar hasta que se reactive la cuenta.',
  'Disable': 'Desactivar',
  'Enable account': 'Activar cuenta',
  'Disable account': 'Desactivar cuenta',
  'Workout history': 'Historial de entrenos',
  '{0} sets': '{0} series',
  '{0} PR': '{0} PR',
  'No workouts logged.': 'Sin entrenos registrados.',
  ...
  'revoke': 'revocar',
  'used': 'usado',
  'No codes yet — generate one to invite someone.': 'Aún no hay códigos — genera uno para invitar.',
  'Failed to load': 'No se pudo cargar',
  'Admin': 'Administración',
  '{0} users · {1} active this week': '{0} usuarios · {1} activos esta semana',
  'refresh': 'actualizar',
  'Users': 'Usuarios',
  'Training now': 'Entrenando ahora',
  'Active 7d': 'Activos 7d',
  'Disabled': 'Desactivados',
  'ex {0}/{1} · {2}/{3} sets': 'ej {0}/{1} · {2}/{3} series',
  'training now · {0}': 'entrenando ahora · {0}',
  '{0} workouts': '{0} entrenos',
  ' · last {0}': ' · último {0}',
  ' · synced {0}': ' · sinc. {0}',
  'off': 'off',
  'No users yet.': 'Aún no hay usuarios.',
  'push enabled': 'push activo',
  'Back': 'Atrás',
  'Self-host MiGYM': 'Aloja tu propio MiGYM',
  'This demo runs entirely in your browser on example data — nothing is sent anywhere. Passkey sign-in and sync across your devices come with the MiGYM server, which you get by self-hosting it.': 'Esta demo corre solo en el navegador con datos de ejemplo: no se envía nada. El inicio con passkey y la sincronización vienen con el servidor de MiGYM.',
  'A gym code is required': 'Se requiere un código de gimnasio',
  'Gym code': 'Código de gimnasio',
  'Enter the code your gym gave you.': 'Introduce el código que te dio tu gimnasio.',
  'Gyms': 'Gimnasios',
  'Join code': 'Código de ingreso',
  'Gym name': 'Nombre del gimnasio',
  'Create gym': 'Crear gimnasio',
  'Gym created': 'Gimnasio creado',
  'Your membership has expired — talk to the gym.': 'Tu membresía venció — hablá con el gimnasio.',
  'Plan': 'Plan',
  'expires {0}': 'vence {0}',
  '{0} sessions left': '{0} sesiones restantes',
  ...
  'Copied your plan': 'Se copió tu plan',
  'Copy my plan to this member': 'Copiar mi plan a este socio',
  'Save': 'Guardar',
  'This week': 'Esta semana',
  'Trained today': 'Entrenaron hoy',
  '{0}/{1} sessions this week': '{0}/{1} sesiones esta semana',
  'today': 'hoy',
  'Make trainer': 'Hacer entrenador',
  'Make member': 'Hacer socio',
  'Role updated': 'Rol actualizado',
  'Set routines': 'Asignar rutinas',
  'Make gym owner': 'Hacer dueño del gimnasio',
  'Owners': 'Dueños',
  'Set gym owner': 'Elegir dueño',
  'Assign': 'Asignar',
  'Rename': 'Renombrar',
  'Gym updated': 'Gimnasio actualizado',
  'Owner set': 'Dueño asignado',
  "Enter an email": "Enter an email",
  "Password must be at least 8 characters": "Password must be at least 8 characters",
  "Passwords do not match": "Passwords do not match",
  "Pick a name, email and password. You can add a passkey later.": "Pick a name, email and password. You can add a passkey later.",
  "Email": "Email",
  "Password": "Password",
  "Confirm password": "Confirm password",
  "Create account": "Create account",
  "Sign in": "Sign in",
  "Passkeys use {0} — add one in Settings after you sign in.": "Passkeys use {0} — add one in Settings after you sign in.",
  "Signed in — data syncs to this profile.": "Signed in — data syncs to this profile.",
  "Change password": "Change password",
  "Add email and password": "Add email and password",
  "Set a password so you can sign in on any device.": "Set a password so you can sign in on any device.",
  "Replace passkey": "Replace passkey",
  "Add a passkey": "Add a passkey",
  "Uses {0} on this device.": "Uses {0} on this device.",
  "Sign in with {0} instead of a password.": "Sign in with {0} instead of a password.",
  "Email and password — you can add a passkey later.": "Email and password — you can add a passkey later.",
  "Signs this profile out on every device, including this one. Sign in again with email and password, or a passkey.": "Signs this profile out on every device, including this one. Sign in again with email and password, or a passkey.",
  "Passkey added": "Passkey added",
  "Current password": "Current password",
  "New password": "New password",
  "Password updated": "Password updated",
  "Enter a password": "Enter a password",
  "e.g. PALERMO": "e.g. PALERMO",
  "Letters, numbers and hyphens — 4 to 24 characters.": "Letters, numbers and hyphens — 4 to 24 characters.",
  "Save code": "Save code",
  "New random code": "New random code",
  "Join code updated": "Join code updated",
  "Invalid join code": "Invalid join code",
  "Change join code": "Change join code",
  "Password set — they must sign in again": "Password set — they must sign in again",
...
"not signed up": "sin cuenta",
  "Add member": "Añadir miembro",
  "Custom code (optional)": "Código personalizado (opcional)",
  "Leave blank for a random code.": "Déjalo vacío para un código aleatorio.",
  "Claim code": "Código personal",
  "Member added": "Miembro añadido",
  "Code regenerated": "Código regenerado",
  "Set custom code": "Código personalizado",
  "This member has not signed up yet.": "Este miembro aún no ha creado su cuenta.",
}
