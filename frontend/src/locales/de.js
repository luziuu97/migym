...
export default {
  ...
  'Owner set': 'Owner set',
  "Enter an email": "Gib eine E-Mail ein",
  "Password must be at least 8 characters": "Passwort muss mindestens 8 Zeichen haben",
  "Passwords do not match": "Passwörter stimmen nicht überein",
  "Pick a name, email and password. You can add a passkey later.": "Wähle Namen, E-Mail und Passwort. Einen Passkey kannst du später hinzufügen.",
  "Email": "E-Mail",
  "Password": "Passwort",
  "Confirm password": "Passwort bestätigen",
  "Create account": "Konto erstellen",
  "Sign in": "Anmelden",
  "Passkeys use {0} — add one in Settings after you sign in.": "Passkeys nutzen {0} — füge einen in den Einstellungen hinzu, nachdem du dich angemeldet hast.",
  "Signed in — data syncs to this profile.": "Angemeldet — Daten werden mit diesem Profil synchronisiert.",
  "Change password": "Passwort ändern",
  "Add email and password": "E-Mail und Passwort hinzufügen",
  "Set a password so you can sign in on any device.": "Lege ein Passwort fest, damit du dich auf jedem Gerät anmelden kannst.",
  "Replace passkey": "Passkey ersetzen",
  "Add a passkey": "Passkey hinzufügen",
  "Uses {0} on this device.": "Nutzt {0} auf diesem Gerät.",
  "Sign in with {0} instead of a password.": "Mit {0} anmelden statt mit Passwort.",
  "Email and password — you can add a passkey later.": "E-Mail und Passwort — einen Passkey kannst du später hinzufügen.",
  "Signs this profile out on every device, including this one. Sign in again with email and password, or a passkey.": "Meldet dieses Profil auf allen Geräten ab, auch auf diesem. Melde dich danach mit E-Mail und Passwort oder einem Passkey wieder an.",
  "Passkey added": "Passkey hinzugefügt",
  "Current password": "Aktuelles Passwort",
  "New password": "Neues Passwort",
  "Password updated": "Passwort aktualisiert",
  "Enter a password": "Gib ein Passwort ein",
  "e.g. PALERMO": "z. B. PALERMO",
  "Letters, numbers and hyphens — 4 to 24 characters.": "Buchstaben, Zahlen und Bindestriche — 4 bis 24 Zeichen.",
  "Save code": "Code speichern",
  "New random code": "Neuen Zufallscode",
  "Join code updated": "Beitrittscode aktualisiert",
  "Invalid join code": "Ungültiger Beitrittscode",
  "Change join code": "Beitrittscode ändern",
  "Password set — they must sign in again": "Passwort gesetzt — sie müssen sich neu anmelden",
  "Set password": "Passwort setzen",
  "No email yet — required for password login.": "Noch keine E-Mail — nötig für die Passwort-Anmeldung.",
  "Email for login": "E-Mail für die Anmeldung",
  "Temporary password": "Temporäres Passwort",
"not signed up": "noch nicht registriert",
  "Add member": "Mitglied hinzufügen",
  "Custom code (optional)": "Eigener Code (optional)",
  "Leave blank for a random code.": "Leer lassen für einen Zufallscode.",
  "Claim code": "Anspruchscode",
  "Member added": "Mitglied hinzugefügt",
  "Code regenerated": "Code erneuert",
  "Set custom code": "Eigenen Code setzen",
  "This member has not signed up yet.": "Dieses Mitglied hat sich noch nicht registriert.",
}
